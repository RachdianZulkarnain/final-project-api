...
export class CalendarService {
  ...
  compareRoomPricing = async (
    ...
    try {
      ...
      console.error("Error in RoomPricingService.compareRoomPricing:", error);
  ...
  getPropertyMonthlyPriceComparison = async (
    ...
    try {
      ...
      console.error(
        "Error in RoomPricingService.getPropertyMonthlyPriceComparison:",
        error
      );
      throw new ApiError(
  ...
  getMonthlyAvailabilityAndPricing = async (
    ...
    try {
      ...
      console.error(
        "Error in RoomPricingService.getMonthlyAvailabilityAndPricing:",
        error
      );
